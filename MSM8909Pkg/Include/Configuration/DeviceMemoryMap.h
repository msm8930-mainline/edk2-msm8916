...
{0x80100000, 0x00100000, "HLOS 0",           AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
{0x80200000, 0x00100000, "UEFI FD",          AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
{0x80300000, 0x00040000, "MPPark Code",      AddMem, MEM_RES, UNCACHEABLE, RtCode, UNCACHED_UNBUFFERED},
{0x80340000, 0x00040000, "HLOS 1",           AddMem, SYS_MEM, SYS_MEM_CAP, BsData, UNCACHED_UNBUFFERED},
...
{0x8038A000, 0x00003000, "Reset Data",       AddMem, SYS_MEM, SYS_MEM_CAP, RtData, UNCACHED_UNBUFFERED},
{0x8038D000, 0x00073000, "Reser. Uncached0", AddMem, SYS_MEM, SYS_MEM_CAP, BsData, UNCACHED_UNBUFFERED},
...
{0x80C40000, 0x00010000, "CPU Vectors",      AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
...
{0x84000000, 0x02000000, "HLOS 3",           AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
{0x86000000, 0x00300000, "TZ Apps",          AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE},
{0x86300000, 0x00100000, "SMEM",             AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED},
{0x86400000, 0x00280000, "NonRelocatable 0", AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE},
{0x86680000, 0x00080000, "HLOS 4",           AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
{0x86700000, 0x06500000, "NonRelocatable 1", AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE},
{0x8CC00000, 0xFFFFFFFFFFFFFFFF, "HLOS 3",   AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
//--------------------- Other Regions ----------------------
{0x08600000, 0x00020000, "IMEM Boot Base",   NoHob,  SYS_MEM, INITIALIZED, Conv,   NS_DEVICE},
{0x08600000, 0x00001000, "IMEM Cookie Base", AddMem, MMAP_IO, INITIALIZED, Conv,   NS_DEVICE},
//--------------------- Register Regions -------------------
